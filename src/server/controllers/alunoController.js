...
exports.adicionarFaltaMat = async (req, res) => {
  try {
    ...
    aluno.faltasMat++;
    await aluno.save();
    await req.flash("falta", "Falta do aluno "+ aluno.firstName + " " + aluno.lastName +" em Matemática foi adicionada.");
...
exports.adicionarFaltaHist = async (req, res) => {
  try {
    ...
    aluno.faltasHist++;
    await aluno.save();
    await req.flash("falta", "Falta do aluno "+ aluno.firstName + " " + aluno.lastName +" em História foi adicionada.");
    res.redirect("/chamada");
  } catch (err) {
    console.error(err);
    res.status(500).send('Erro ao adicionar falta');
...
exports.adicionarFaltaPort = async (req, res) => {
  try {
    ...
    aluno.faltasPort++;
    await aluno.save();
    await req.flash("falta", "Falta do aluno "+ aluno.firstName + " " + aluno.lastName +" em Português foi adicionada.");
    res.redirect("/chamada");
  } catch (err) {
    console.error(err);
    res.status(500).send('Erro ao adicionar falta');
...
exports.adicionarFaltaBio = async (req, res) => {
  try {
    ...
    aluno.faltasBio++;
    await aluno.save();
    await req.flash("falta", "Falta do aluno "+ aluno.firstName + " " + aluno.lastName +" em Biologia foi adicionada.");
    res.redirect("/chamada");
  } catch (err) {
    console.error(err);
    res.status(500).send('Erro ao adicionar falta');
...
exports.adicionarFaltaQuim = async (req, res) => {
  try {
    ...
    aluno.faltasQuim++;
    await aluno.save();
    await req.flash("falta", "Falta do aluno "+ aluno.firstName + " " + aluno.lastName +" em Química foi adicionada.");
    res.redirect("/chamada");
  } catch (err) {
    console.error(err);
    res.status(500).send('Erro ao adicionar falta');
...
exports.adicionarFaltaFilo = async (req, res) => {
  try {
    ...
    aluno.faltasFilo++;
    await aluno.save();
    await req.flash("falta", "Falta do aluno "+ aluno.firstName + " " + aluno.lastName +" em Filosofia foi adicionada.");
    res.redirect("/chamada");
  } catch (err) {
    console.error(err);
    res.status(500).send('Erro ao adicionar falta');
...
exports.adicionarFaltaFis = async (req, res) => {
  try {
    ...
    aluno.faltasFis++;
    await aluno.save();
    await req.flash("falta", "Falta do aluno "+ aluno.firstName + " " + aluno.lastName +" em Física foi adicionada.");
    res.redirect("/chamada");
  } catch (err) {
    console.error(err);
    res.status(500).send('Erro ao adicionar falta');
